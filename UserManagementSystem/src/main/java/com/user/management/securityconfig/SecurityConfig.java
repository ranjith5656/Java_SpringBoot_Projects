...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
            .antMatchers("/api/admin/**").hasRole("ADMIN")// Only admin with "ADMIN" role can access URLs starting with "/api/admin/"
            .antMatchers("/api/users/**").hasAnyRole("USER")// Only users with "USER" role can access URLs starting with "/api/users/"
